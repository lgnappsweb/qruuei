...
export default function OcorrenciaTO04Page() {
  ...
  React.useEffect(() => {
    try {
        ...
        if (editDataString) {
            ...
            if(editData.formPath === '/ocorrencias/to04') {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <PreviewDialog data={previewData} onClose={() => setPreviewData(null)} onSave={handleSave} formTitle="REMOÇÃO (TO04)" />
    </div>
  );
}
