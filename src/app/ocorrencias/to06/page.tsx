...
export default function OcorrenciaTO06Page() {
  ...
  React.useEffect(() => {
    try {
        ...
        if (editDataString) {
            ...
            if(editData.formPath === '/ocorrencias/to06') {
  ...
  async function handleSave(data: any) {
    ...
    try {
        const formTitle = "PANE SOBRE FAIXA DE ROLAMENTO (TO06)";
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-24">
      ...
      <PreviewDialog data={previewData} onClose={() => setPreviewData(null)} onSave={handleSave} formTitle="PANE SOBRE FAIXA DE ROLAMENTO (TO06)" />
    </div>
  );
}
