...
const auxilios = [
  ...
  { id: 'PR23', label: 'PR23 - Remoção de óleo/outros com serragem' },
...
const PreviewDialog = ({ data, onClose, onSave, formTitle }: { data: any | null; onClose: () => void; onSave: (data: any) => void; formTitle: string; }) => {
  ...
  const handleShare = () => {
    ...
    const sections: { title: string, fields: (keyof z.infer<typeof formSchema>)[] }[] = [
        { title: 'Informações Gerais', fields: ['rodovia', 'ocorrencia', 'qth', 'sentido', 'localArea', 'qthInicio', 'qthTermino', 'extensao'] },
...
export default function OcorrenciaTO35Page() {
  ...
  React.useEffect(() => {
    try {
        ...
        if (editDataString) {
            ...
            if(editData.formPath === '/ocorrencias/to35') {
  ...
  async function handleSave(data: any) {
    ...
    try {
        const formTitle = "ÓLEO SOBRE A PISTA (TO35)";
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-24">
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: 100 metros" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Descreva os auxílios prestados. Ex: PR23, PR13"
                          className="resize-none"
                          {...field}
                        />
                      </FormControl>
      ...
      <PreviewDialog data={previewData} onClose={() => setPreviewData(null)} onSave={handleSave} formTitle="ÓLEO SOBRE A PISTA (TO35)" />
    </div>
  );
}
