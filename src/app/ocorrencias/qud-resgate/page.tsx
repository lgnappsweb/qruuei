...
const formSchema = z.object({
  ...
  // AVALIAÇÃO PRIMÁRIA
  hemorragiaExsanguinante: z.boolean().optional(),
  ...
  sangramentoAtivo: z.boolean().optional(),
  glasgowInicial: z.string().optional(),
  pupilas: z.string().optional(),
  fotorreagentes: z.boolean().optional(),
  exposicao: z.string().optional(),
  hipotermia: z.boolean().optional(),
                ...
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="space-y-6 pt-4">
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <FormField control={form.control} name="km" render={({ field }) => (<FormItem><FormLabel>KM</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>)}/>
                         </div>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormField control={form.control} name="equipe" render={({ field }) => (<FormItem><FormLabel>Equipe</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>)}/>
