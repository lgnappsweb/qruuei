...
export default function OcorrenciaTO05Page() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-24">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="TO05">TO05</SelectItem>
                          <SelectItem value="TO05 / TO06">TO05 / TO06</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
      ...
      <PreviewDialog data={previewData} onClose={() => setPreviewData(null)} onSave={handleSave} formTitle="INCÊNDIO EM VEÍCULOS (TO05)" />
    </div>
  );
}
