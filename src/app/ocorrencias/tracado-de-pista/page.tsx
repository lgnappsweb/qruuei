        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6 pt-6">
              ...
              <FormField control={form.control} name="sentidoPrevia" render={({ field }) => ( <FormItem> <FormLabel>Sentido</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex space-x-4"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Norte" /></FormControl> <FormLabel className="font-normal text-base">Norte</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Sul" /></FormControl> <FormLabel className="font-normal text-base">Sul</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
              <FormField control={form.control} name="faixaInterditada" render={({ field }) => ( <FormItem> <FormLabel>Faixa de rolamento interditada?</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex flex-wrap gap-x-4 gap-y-2"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Norte e Sul" /></FormControl> <FormLabel className="font-normal text-base">Norte e Sul</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Norte" /></FormControl> <FormLabel className="font-normal text-base">Norte</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Sul" /></FormControl> <FormLabel className="font-normal text-base">Sul</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="NILL" /></FormControl> <FormLabel className="font-normal text-base">NILL</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
          ...
          <Card>
            ...
            <CardContent className="space-y-6 pt-6">
              ...
              <FormField control={form.control} name="energia" render={({ field }) => ( <FormItem> <FormLabel>Energia</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex space-x-4"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Baixa" /></FormControl> <FormLabel className="font-normal text-base">Baixa</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Média" /></FormControl> <FormLabel className="font-normal text-base">Média</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Alta" /></FormControl> <FormLabel className="font-normal text-base">Alta</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
              <FormField control={form.control} name="avarias" render={({ field }) => ( <FormItem> <FormLabel>Avarias</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex space-x-4"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Poucas" /></FormControl> <FormLabel className="font-normal text-base">Poucas</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Moderadas" /></FormControl> <FormLabel className="font-normal text-base">Moderadas</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Grandes" /></FormControl> <FormLabel className="font-normal text-base">Grandes</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
              <FormField control={form.control} name="posicaoVeiculo" render={({ field }) => ( <FormItem> <FormLabel>Posição do veículo</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="space-y-2"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Posição original" /></FormControl> <FormLabel className="font-normal text-base">Posição original</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Com os rodados para cima/ ângulo de 180°" /></FormControl> <FormLabel className="font-normal text-base">Com os rodados para cima/ ângulo de 180°</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="Lateralizado/ ângulo de 90°" /></FormControl> <FormLabel className="font-normal text-base">Lateralizado/ ângulo de 90°</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
              ...
              <FormField control={form.control} name="cod61_62" render={({ field }) => ( <FormItem> <FormLabel>Cód. 61/62?</FormLabel> <FormControl> <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex space-x-4"> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="61" /></FormControl> <FormLabel className="font-normal text-base">61</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="62" /></FormControl> <FormLabel className="font-normal text-base">62</FormLabel> </FormItem> <FormItem className="flex items-center space-x-2 space-y-0"> <FormControl><RadioGroupItem value="NILL" /></FormControl> <FormLabel className="font-normal text-base">NILL</FormLabel> </FormItem> </RadioGroup> </FormControl> <FormMessage /> </FormItem> )} />
